        ...
        {members.map((member, index) => {
          ...
          return (
            <div 
              ...
              className={clsx(
                "group p-3 rounded-2xl flex items-center justify-between cursor-pointer transition-all duration-300 border backdrop-blur-sm",
                isPaid 
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className={clsx(
                  ...
                  isPaid 
                    ? "bg-primary-500 text-black shadow-[0_0_10px_rgba(34,197,94,0.4)]" 
                ...
                <div>
                  <p className={clsx(
                    ...
                    isPaid ? "text-primary-200" : "text-white group-hover:text-white"
                  )}>
                    {member.name}
                  </p>
                  <p className={clsx(
              ...
              {/* Action Button */}
              <div className={clsx(
                "w-10 h-10 rounded-full flex items-center justify-center transition-all duration-500 ease-elastic-out transform",
                isPaid 
                  ? "bg-primary-500 text-black shadow-lg shadow-primary-500/30 rotate-0 scale-100" 
                  : "bg-white/10 text-white/30 rotate-45 group-hover:bg-white/20 group-hover:text-white/60 scale-90"
              )}>
